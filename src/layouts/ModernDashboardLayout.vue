      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
          ...
          <div class="flex items-center gap-3">
            <div class="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-md">
            ...
            <div>
              ...
              <p class="text-xs text-gray-500 hidden sm:block">Manage your orders efficiently</p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-4">
            <!-- Month selector -->
            <div class="hidden sm:flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-lg border border-gray-200">
            ...
            <div class="relative">
              ...
              >
                <div class="w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-semibold text-sm shadow-md">
                  {{ authStore.userName?.charAt(0)?.toUpperCase() || 'U' }}
                </div>
                <div class="hidden md:block text-left">
                  <p class="text-sm font-medium text-gray-900 max-w-[120px] truncate">
                    {{ authStore.userName || 'User' }}
                  </p>
                  <p class="text-xs text-gray-500">{{ authStore.userRole || 'Unknown' }}</p>
                </div>
                <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                <!-- User info header -->
                <div class="px-4 py-3 bg-gradient-to-r from-blue-500 to-purple-500">
                  ...
                  <div class="mt-2 inline-flex items-center px-2 py-1 bg-white bg-opacity-20 rounded-full">
                    <span class="text-xs font-medium text-white">{{ authStore.userRole || 'Unknown' }}</span>
                  </div>
                </div>
        ...
        <nav class="hidden md:flex items-center gap-1 px-4 sm:px-6 lg:px-8 border-t border-gray-100">
          <router-link
